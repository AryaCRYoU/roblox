...
func main() {
	...
	if version {
		fmt.Println("crash-VIP", __version__)
		os.Exit(0)
	}
	...
	go func() {
		fmt.Println("\u001B[31m🚀crash-VIP ATTACK STARTED🚀\u001B[35m\n           Go!\n\n")
		...
		for {
			...
			case targetComplete:
				...
				fmt.Println("\r🚀crash-VIP ATTACK FINISHED🚀     \n\n\r")
				os.Exit(0)
			}
		}
	}()
